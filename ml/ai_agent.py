...
class SupportAgent:
    def __init__(self, 
                 ...
                 ollama_base_url: str = "http://46.227.68.167:22065/",
...
Отвечайте на вопросы пользователя ТОЛЬКО на основе информации из предоставленных документов. 
Если ответа нет в документах или вы не уверены, сразу предлагайте перевод к оператору. 

Формат ответа:
<topic>Тема диалога</topic>
<answer>Ответ модели</answer>

Примеры:
<topic>Вопрос о тарифах</topic>
<answer>Извините, не нашел информации. Соединяю вас с оператором.</answer>

Всегда проверяйте документы перед ответом. Если информации недостаточно, не пытайтесь угадать.
"""
